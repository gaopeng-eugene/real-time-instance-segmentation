...
pretrain_model = "models/VGGNet/VGG_coco_SSD_300*300.caffemodel"
# Stores LabelMapItem.
...
# Create train net.
net = caffe.NetSpec()
net.data, net.label ,net.label_mask = CreateAnnotatedDataLayer(train_data, batch_size=batch_size_per_device,
...
name = "mbox_loss"
mbox_layers.insert(3,net.label)
mbox_layers.append(net.label_mask)
net[name] = L.MultiBoxLoss(*mbox_layers, multibox_loss_param=multibox_loss_param,
        loss_param=loss_param, include=dict(phase=caffe_pb2.Phase.Value('TRAIN')),
        propagate_down=[True, True, False, False, True ,False])
...
# Create test net.
net = caffe.NetSpec()
net.data, net.label ,net.label_mask = CreateAnnotatedDataLayer(test_data, batch_size=test_batch_size,
