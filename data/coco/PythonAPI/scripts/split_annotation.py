...
MASK_DIR = "/home/gaopeng/Desktop/data/mask/"
    ...
    for img_id in img_ids:
        ...
        if out_dir:
            ...
            for anno in annos:
                ...
                mask_dir = MASK_DIR + "%d.jpg"%anno['id']
                anno['mask_dir'] = mask_dir
                crop_mask = mask[int(anno['bbox'][1]):int(anno['bbox'][1]+anno['bbox'][3]+1),int(anno['bbox'][0]):int(anno['bbox'][0]+anno['bbox'][2]+1)]
                cv2.imwrite(mask_dir,crop_mask)
            img_anno = dict()
            img_anno["image"] = img[0]
            img_anno["annotation"] = annos
