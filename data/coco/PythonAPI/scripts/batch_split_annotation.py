...
coco_data_dir = "{}/data".format(HOMEDIR)
# The sets that we want to split. These can be downloaded at: http://mscoco.org
# Unzip all the files after download.
anno_sets = ["instances_minival2014","image_info_test2014", "image_info_test2015", "image_info_test-dev2015",
...
anno_sets = anno_sets + ["instances_valminusminival2014"]
