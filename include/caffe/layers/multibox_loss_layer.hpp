...
class MultiBoxLossLayer : public LossLayer<Dtype> {
 public:
  ...
  // bottom[4] stores the mask predictions.
  // bottom[5] stores the mask ground truth.
 ...
 protected:
  ...
  shared_ptr<Layer<Dtype> > mask_loss_layer_;
  vector<Blob<Dtype>*> mask_bottom_vec_;
  vector<Blob<Dtype>*> mask_top_vec_;
  Blob<Dtype> mask_pred_;
  Blob<Dtype> mask_gt_;
  Blob<Dtype> mask_loss_;
